...
- `analysis_simoes_moreira.py`: plot the Simoes-Moreira density profile and compare experimental, 5-equation, 6-equation, and published `U_F` versus `T` results in a 1x2 layout, with `--to-thesis` PDF export support
